...
public class Statistics implements Comparable {
	...
	long broadcast_publish;
	long ipns_name_publish;
	...
	public long getFiltered_triples() {
		return filtered_triples;
	}


	public void setFiltered_triples(long filtered_triples) {
		this.filtered_triples = filtered_triples;
	}

	public void addFiltered_triples(long filtered_triples) {
		this.filtered_triples += filtered_triples;
	}
	...
	public long getIfc_split() {
		return ifc_split;
	}


	public void setIfc_split(long ifc_split) {
		this.ifc_split = ifc_split;
	}

	public void addIfc_split(long ifc_split) {
		this.ifc_split += ifc_split;
	}
	...
	public long getBroadcast_publish() {
		return broadcast_publish;
	}


	public void setBroadcast_publish(long broadcast_publish) {
		this.broadcast_publish = broadcast_publish;
	}


	public long getIpns_name_publish() {
		return ipns_name_publish;
	}


	public void setIpns_name_publish(long ipns_name_publish) {
		this.ipns_name_publish = ipns_name_publish;
	}
	...
	public String toString() {
		...
		ret.append(this.filtered_triples+";");
		ret.append(this.ifc_root_entities+";");
		ret.append((this.process_stop_time-this.process_start_time)+";");
		
		ret.append(this.ifc_convert+";");
		ret.append(this.ifc_split+";");
		ret.append(this.publish_merkle_nodes+";");
		ret.append(this.publish_directory_node+";");
		ret.append(this.broadcast_publish+";");
		ret.append(this.ipns_name_publish+";");
