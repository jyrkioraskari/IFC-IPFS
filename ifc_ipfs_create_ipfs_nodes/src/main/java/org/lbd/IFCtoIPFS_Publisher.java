...
public class IFCtoIPFS_Publisher {
	...
	public IFCtoIPFS_Publisher(String name) {
	...
	public void add(String ifc_file) throws InterruptedException, IOException {
		...
		System.out.println("Directory hash: "+project_table.hash.toBase58());
		// IPNS
		/*try {
	...
	public static void main(String[] args) {
		try {
			IFCtoIPFS_Publisher ifc_ipfs=new IFCtoIPFS_Publisher("IFC project");
			if(args.length>0)
			  ifc_ipfs.add(args[0]);
