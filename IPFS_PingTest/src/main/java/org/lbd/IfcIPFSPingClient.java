...
import org.lbd.process.IPFSPingClientProcess;
...
public class IfcIPFSPingClient {

	private final IPFS ipfs;
	static public long start_time;

	private IfcIPFSPingClient() throws InterruptedException, IOException {
        System.out.println("Client starts");
		ipfs = new IPFS("/ip4/127.0.0.1/tcp/5001");
		new Thread(new IPFSPingClientProcess(ipfs,"IFCBIM")).start();
	...
	public static void main(String[] args) {
		System.out.println("Remember to check the directory hash");
		try {
			new IfcIPFSPingClient();
