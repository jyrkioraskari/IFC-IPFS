...
public class IFCtoLBDFiles_Stats {
	...
	public IFCtoLBDFiles_Stats(String output_directory, String version_name) {
	...
	public static void main(String[] args) {
		try {
			if (args.length > 1) {
				IFCtoLBDFiles_Stats ifc_ipfs = new IFCtoLBDFiles_Stats(args[1], "V1");
				ifc_ipfs.add(args[0]);
			}
