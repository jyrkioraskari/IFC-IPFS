...
public class IPFS_Repeated100FetchWebDir extends IPFS_Fetch{
	...
	public IPFS_Repeated100FetchWebDir(String baseURL) throws IOException {
	...
	public void fetch(String baseURL,boolean jena) {
		...
		System.out.println("Read WEB DIR");
	...
	public static void main(String[] args) {
		for (int n = 0; n < 100; n++) {
			try {
				new IPFS_Repeated100FetchWebDir("http://94.237.54.151:8080/");
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
