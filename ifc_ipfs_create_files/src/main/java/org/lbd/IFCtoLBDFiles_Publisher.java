...
public class IFCtoLBDFiles_Publisher {
	...
	public IFCtoLBDFiles_Publisher(String output_directory, String version_name) {
	...
	private void createEntityNode(String guid, Model model, Resource guid_subject) {
		try {
	...
	public static void main(String[] args) {
		try {
			if(args.length>1)
			{
				IFCtoLBDFiles_Publisher ifc_ipfs = new IFCtoLBDFiles_Publisher(args[1], "V1");
				  ifc_ipfs.add(args[0]);
			}
