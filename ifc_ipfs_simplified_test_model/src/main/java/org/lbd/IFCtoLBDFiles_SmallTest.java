...
public class IFCtoLBDFiles_SmallTest {
	...
	public IFCtoLBDFiles_SmallTest(String output_directory, String version_name) {
	...
	public static void main(String[] args) {
		try {
			if (args.length > 1) {
				IFCtoLBDFiles_SmallTest ifc_ipfs = new IFCtoLBDFiles_SmallTest(args[1], "V1");
				ifc_ipfs.add(args[0]);
			}
